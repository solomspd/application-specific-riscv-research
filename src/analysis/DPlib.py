    ...
    for i in range(len(lookup_file['modules'])): 
        for j in range(len(lookup_file['modules'][i]['output'])):
            if(lookup_file['modules'][i]['output'][j]['length']==1):
                f.write("wire %s;" %(lookup_file['modules'][i]['output'][j]['name']))
                f.write('\n');
                print("wire %s;" %(lookup_file['modules'][i]['output'][j]['name']))
            else:
                f.write("wire [%d:0] %s;" %((lookup_file['modules'][i]['output'][j]['length']-1), lookup_file['modules'][i]['output'][j]['name']))
                f.write('\n');
                print("wire [%d:0] %s;" %((lookup_file['modules'][i]['output'][j]['length']-1), lookup_file['modules'][i]['output'][j]['name']))
